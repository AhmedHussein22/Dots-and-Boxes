...
size_of_board = 600
number_of_dots = 6  # 6*6
symbol_size = (size_of_board / 3 - size_of_board / 8) / 2
symbol_thickness = 50
dot_color = '#2fc4b2'
player1_color = '#e71414'
player1_color_light = '#e71414'
player2_color = '#f17808'
player2_color_light = '#f17808'
Green_color = '#ff2fc3'
...
class Dots_and_Boxes(): # main class
    # ------------------------------------------------------------------
    # Initialization functions
    # to Initialize window before game start
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # play_again Function
    # After end game if user want play again
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # convert_grid_to_logical_position Function
    # to convert all network of row and columns to known position
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # mark_box Function
    # to draw the box with the same color of player's color if payer select box from all sides
    # ------------------------------------------------------------------
    ...
    # to update board(all dots and lines if selected) and change player number if 1 or 2...and so on
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    #  make_edge Functions:
    # to drawing The modules required to draw required game based object on canvas
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # display_game over Functions:
    # in the end of game(After make all edges display game over and who is the  winner
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # refresh_board Functions:
    # to refresh to start new game
    # ------------------------------------------------------------------
        ...
        for i in range(number_of_dots):
            for j in range(number_of_dots):
                ...
                self.canvas.create_oval(start_x-dot_width/2, end_x-dot_width/2, start_x+dot_width/2,
                                        ...
                                        outline=dot_color)
    # ------------------------------------------------------------------
    # display_turn_text Functions:
    # to display who is the next player
    # ------------------------------------------------------------------
    ...
    # ------------------------------------------------------------------
    # click Functions:
    # what happen when the payer press on the edges
    # ------------------------------------------------------------------
